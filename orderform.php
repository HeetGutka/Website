...
//triming name
	try {
		...
		// Check if email already exists
						...
						<font face="bookman">
							We send you a verification call very soon.<br>Your order will be delivered within 2 hours.
						</font></div></div>';
						}else{
	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="women/toilatry.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Toiletry</a></th>
				<th><a href="women/grocery.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Grocery</a></th>
			</tr>
		</table>
	</div>
						...
						<ul style="float: left;">
							<li style="float: left; padding: 0px 25px 25px 25px;">
								<div class="home-prodlist-img"><a href="'.$category.'/view_product.php?pid='.$id.'">
									...
									<div style="text-align: center; padding: 0 0 6px 0;"> <span style="font-size: 15px;">'.$pName.'</span><br> Price: <span id="amountText">'.$price.'</span> INR <span id="aHiddenText" style="display:none">'.$price.'</span></div>
								</div>

...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="toilatry.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Toiletry</a></th>
				<th><a href="grocery.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Grocery</a></th>
			</tr>
		</table>
	</div>
			...
			echo '
				...
				<div style="float: right;width: 40%;color: #067165;background-color: #ddd;padding: 10px;">
					<div style="">
						...
						<h3 style="padding: 20px 0 0 0; font-size: 20px;">Prize: '.$price.' INR</h3><hr>
	...
	<div style="padding: 30px 95px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<h3 style="padding-bottom: 20px">Recommended Product For You:</h3>
		<div>
		<?php 
			$getposts = mysqli_query($con, "SELECT * FROM products WHERE available >='1' AND id != '".$pid."' AND item ='".$item."'  ORDER BY RAND() LIMIT 3") or die(mysqli_error($con));
					if (mysqli_num_rows($getposts)) {
					echo '<ul id="recs">';
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid='.$id.'">
										...
										<div style="text-align: center; padding: 0 0 6px 0;"> <span style="font-size: 15px;">'.$pName.'</span><br> Price: '.$price.' INR</div>
									</div>
